package xyz.injector.subwaysurf;
...
public class Utils {
    ...
    public static final String targetPackage = "com.kiloo.subwaysurf" ;   // Target package name
    ...
    public static boolean inject(Context context){
        ...
        /* Copy injector & payload into /data/data/package-name/cache */
         extractFileFromApkAndSaveToCache(context, "assets/arm64-v8a/"  + injector  , injector );
         extractFileFromApkAndSaveToCache(context, "lib/arm64-v8a/"     + payload   , payload  );
